...
-- Generated: 2026-06-30T10:14:47.762Z
-- Source: live qsl_erp.db (117 tables, 30 indexes)
...
CREATE TABLE calibration_certs (
  ...
  etims_ref       TEXT,
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, instrument_type TEXT DEFAULT 'general', temp_c_end NUMERIC(15,2), humidity_pct_end NUMERIC(15,2), min_weight TEXT, repeatability_stdev NUMERIC(15,2), checked_at TEXT, checked_by TEXT REFERENCES employees(id), checked_sig TEXT);
...
CREATE TABLE civil_works_holdpoints (
  id              TEXT PRIMARY KEY,
...
CREATE TABLE disciplinary_steps (
  id          TEXT PRIMARY KEY,
...
CREATE TABLE employees (
  ...
  created_at        TEXT DEFAULT (CURRENT_TIMESTAMP),
  updated_at        TEXT DEFAULT (CURRENT_TIMESTAMP)
, helb_monthly NUMERIC(15,2) DEFAULT 0, cpd_points NUMERIC(15,2) DEFAULT 0, cpd_target NUMERIC(15,2) DEFAULT 20);
...
CREATE TABLE exchange_rates (
  ...
  rate_to_kes NUMERIC(15,2) NOT NULL,            -- 1 unit of currency = rate_to_kes KES
...
CREATE TABLE imprest (
  ...
  notes           TEXT,
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, expected_return_date TEXT, line_manager_id TEXT, released_by TEXT, released_at TEXT, spot_check INTEGER DEFAULT 0, advance_balance NUMERIC(15,2) DEFAULT 0, deducted_in_run TEXT, deducted_at TEXT, notified_at TEXT);
...
CREATE TABLE job_work_inspections (
  id              TEXT PRIMARY KEY,
  job_id          TEXT REFERENCES calibration_jobs(id),
...
CREATE TABLE journal_entries (
  ...
  reversed_by     TEXT,
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, auto_reverse INTEGER DEFAULT 0, reversal_date TEXT);
...
CREATE TABLE lpos (
  ...
  notes           TEXT,
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, currency TEXT DEFAULT 'KES', fx_rate NUMERIC(15,2) DEFAULT 1, fx_buffer_pct NUMERIC(15,2) DEFAULT 0, lead_time_days INTEGER DEFAULT 0, freight NUMERIC(15,2) DEFAULT 0, duty NUMERIC(15,2) DEFAULT 0, insurance NUMERIC(15,2) DEFAULT 0, landed_cost NUMERIC(15,2) DEFAULT 0);
...
CREATE TABLE monthly_appraisals (
  id                TEXT PRIMARY KEY,
  employee_id       TEXT REFERENCES employees(id),
  ...
  self_score        NUMERIC(15,2),                        -- 0-100, employee's own rating
  manager_score      NUMERIC(15,2),                        -- 0-100, set by reporting_to
...
CREATE TABLE nawi_eccentricity_readings (
  id              TEXT PRIMARY KEY,
  cert_id         TEXT REFERENCES calibration_certs(id),
  position        TEXT NOT NULL,   -- Centre, Front-Left, Rear-Left, Rear-Right, Front-Right
  indication      NUMERIC(15,2),
  deviation       NUMERIC(15,2),
  sort_order      INTEGER DEFAULT 0
);

CREATE TABLE nawi_repeatability_readings (
  id              TEXT PRIMARY KEY,
  cert_id         TEXT REFERENCES calibration_certs(id),
...
CREATE TABLE overtime (
  ...
  employee_id   TEXT REFERENCES employees(id),
  period        TEXT NOT NULL,             -- YYYY-MM
  weekday_hours NUMERIC(15,2) DEFAULT 0,
  holiday_hours NUMERIC(15,2) DEFAULT 0,
  amount        NUMERIC(15,2) DEFAULT 0,            -- computed KES
...
CREATE TABLE payment_vouchers (
  ...
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, supplier_invoice_id TEXT, batch_id TEXT, required_level TEXT);
...
CREATE TABLE payroll_entries (
  ...
  status          TEXT DEFAULT 'pending',
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, helb NUMERIC(15,2) DEFAULT 0, overtime NUMERIC(15,2) DEFAULT 0);
...
CREATE TABLE payroll_runs (
  ...
  locked_at       TEXT,
  created_at      TEXT DEFAULT (CURRENT_TIMESTAMP)
, cutoff_date TEXT, pay_date TEXT);
...
CREATE TABLE supplier_invoices (
  ...
  lpo_amount      NUMERIC(15,2),                       -- snapshot of LPO grand_total at match time
  invoice_date    TEXT,
...
CREATE TABLE travel_claim_lines (
  id              TEXT PRIMARY KEY,
...
CREATE INDEX idx_appraisals_employee ON monthly_appraisals(employee_id);
...
CREATE INDEX idx_cpd_logs_employee ON cpd_logs(employee_id);
CREATE INDEX idx_credit_notes_client ON credit_notes(client_id);
CREATE INDEX idx_debit_notes_client ON debit_notes(client_id);
CREATE INDEX idx_employees_dept ON employees(department);
CREATE INDEX idx_holdpoints_inspection ON civil_works_holdpoints(inspection_id);
CREATE INDEX idx_imprest_employee ON imprest(employee_id);
CREATE INDEX idx_imprest_status ON imprest(status);
CREATE INDEX idx_inspections_serial ON inspections(equipment_serial);
CREATE INDEX idx_inspections_status ON inspections(status);
CREATE INDEX idx_inspectors_employee ON inspectors(employee_id);
...
CREATE INDEX idx_job_inspections_job ON job_work_inspections(job_id);
CREATE INDEX idx_job_photos_job ON job_photos(job_id);
CREATE INDEX idx_nawi_eccen_cert ON nawi_eccentricity_readings(cert_id);
CREATE INDEX idx_nawi_points_cert ON nawi_test_points(cert_id);
CREATE INDEX idx_nawi_repeat_cert ON nawi_repeatability_readings(cert_id);
CREATE INDEX idx_projects_status ON projects(status);
CREATE INDEX idx_quotes_client ON quotes(client_id);
CREATE INDEX idx_sop_dept ON sop_documents(department);
CREATE INDEX idx_sop_versions_sop ON sop_document_versions(sop_id);
CREATE INDEX idx_travel_claims_employee ON travel_claims(employee_id);
CREATE INDEX idx_warnings_employee ON performance_warnings(employee_id);